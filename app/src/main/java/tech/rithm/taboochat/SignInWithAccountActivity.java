...
public class SignInWithAccountActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.layout_activity_sign_in_with_account);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener(){
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth){
                ...
                if(user != null){
                    startActivity(new Intent(SignInWithAccountActivity.this, MainActivity.class));
                    finish();
                }
            }
        };
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isSuccessful()){
                            Toast.makeText(SignInWithAccountActivity.this, R.string.auth_failed,
